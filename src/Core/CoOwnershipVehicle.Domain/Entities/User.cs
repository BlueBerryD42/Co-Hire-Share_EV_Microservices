...
public class User : IdentityUser<Guid>
{
    ...
    public virtual ICollection<FundTransaction> InitiatedFundTransactions { get; set; } = new List<FundTransaction>();
    public virtual ICollection<FundTransaction> ApprovedFundTransactions { get; set; } = new List<FundTransaction>();
}
