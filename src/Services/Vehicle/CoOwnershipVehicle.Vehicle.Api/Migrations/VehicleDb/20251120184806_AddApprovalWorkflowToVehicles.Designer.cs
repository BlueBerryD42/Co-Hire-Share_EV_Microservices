...
namespace CoOwnershipVehicle.Vehicle.Api.Migrations.VehicleDb
{
    ...
    [Migration("20251120184806_AddApprovalWorkflowToVehicles")]
    partial class AddApprovalWorkflowToVehicles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoOwnershipVehicle.Domain.Entities.Vehicle", b =>
                {
                    ...
                    b.Property<Guid?>("OwnershipGroupId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CoOwnershipVehicle.Domain.Entities.Vehicle", b =>
                {
                    b.HasOne("CoOwnershipVehicle.Domain.Entities.OwnershipGroup", null)
                        .WithMany("Vehicles")
                        .HasForeignKey("OwnershipGroupId");
                });
